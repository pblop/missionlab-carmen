...
/* $Id: obstacle.hpp,v 1.1.1.1 2008/07/14 16:44:22 endo Exp $ */
...
public: 
  ...
  obstacle(double x, double y, double r, double h, const char *color)
   {
      x_ = x;
      y_ = y;
      r_ = r;
      h_ = h;
      sprintf(heightstr, "%.1f", h_);
   ...
   { 
      warn_once("This object can not be moved");         
   }

   void unbind(shape *owner)
   { 
      warn_once("Hmm, how is the robot carrying an unmovable object?");         
   }
...
//
// Revision 1.10  2000/10/16 19:39:40  endo
// Modified due to the compiler upgrade.
//
// Revision 1.9  1999/12/16 22:50:05  mjcramer
// rh6 port
//
// Revision 1.8  1997/02/12  05:41:37  zchen
// *** empty log message ***
//
// Revision 1.7  1996/03/04  00:04:30  doug
// *** empty log message ***
//
// Revision 1.6  1996/02/28  03:54:51  doug
// *** empty log message ***
//
// Revision 1.5  1996/02/27  05:00:04  doug
// *** empty log message ***
//
// Revision 1.4  1996/02/16  00:06:44  doug
// *** empty log message ***
//
...
//
// Revision 1.1  1995/11/06  18:41:44  doug
// Initial revision
//
///////////////////////////////////////////////////////////////////////
