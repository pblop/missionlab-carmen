...
const string CNPEOIRAndMADTask::GetTaskName()               { return "EOIRAndMADTask"; }

double CNPEOIRAndMADTask::CalculateBid(list< struct CNP_RobotConstraint> lstRobotConstraints) {
