...
/* $Id: PCSensorFuser.h,v 1.1.1.1 2006/07/12 13:37:57 endo Exp $ */

#ifndef POSECALC_SENSOR_FUSER_H
#define POSECALC_SENSOR_FUSER_H
...
//-----------------------------------------------------------------------
// Generic PoseCalcSensorFuser class. To be derived by a specific
// method (e.g., EKF, Particle Filter, Max Confidence, etc.).
//-----------------------------------------------------------------------

class PoseCalcSensorFuser : public PoseCalcSensorFuserInterface {

protected:
    PoseCalcSensoryDataBusInterface *sensoryDataBus_;

    const int FUSER_TYPE_;
