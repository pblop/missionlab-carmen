 ...
 **  cmdl_extra.cc                                                   **
 **                                                                  **
 **  Factory object to create the extra data record for cmdls        **
 **                                                                  **
...
/* $Id: cmdl_extra.cc,v 1.1.1.1 2008/07/14 16:44:15 endo Exp $ */
...
cmdl_extra *(* cmdl_extra::factory)(cmdl *)= NULL;

/**********************************************************************/
// Create an extra record
cmdl_extra *
cmdl_extra::create(cmdl *p)
{
   if( factory )
   {
      return factory(p);
