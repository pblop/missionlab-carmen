#ifndef Robot_ParmList_H
#define Robot_ParmList_H
/**********************************************************************
 **                                                                  **
 **  Robot_ParmList.h - A parameter list                             **
 **                                                                  **
...
/* $Id: Robot_ParmList.h,v 1.1.1.1 2008/07/14 16:44:15 endo Exp $ */

///////////////////////////////////////////////////////////////////////
// $Log: Robot_ParmList.h,v $
...
class Robot_ParmList 
{
   ...
   private:
      // convience type
      typedef map<string, string> Robot_ParmList_t;

      // The list
      Robot_ParmList_t parmlist;
};
