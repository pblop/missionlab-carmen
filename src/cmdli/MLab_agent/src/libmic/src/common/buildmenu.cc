...
/* $Id: buildmenu.cc,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
/* The final version of BuildMenu() is used to build popup, option, pulldown
 * and pullright menus.  Menus are defined by declaring an array of MenuItem 
 * structures as usual.
 */
#include <Xm/MainW.h>
#include <Xm/PanedW.h>
...
/**********************************************************************/
MenuItem::MenuItem(char *_label, WidgetClass *_cl, char _mnemonic, 
                   char *_accelerator, char *_accel_text, 
		   XtCallbackProc _callback, XtPointer _callback_data,
		   MenuItems *_subitems) :
	label(_label),
	cl(_cl),
	mnemonic(_mnemonic), 
	accelerator(_accelerator),
	accel_text(_accel_text),
	callback(_callback),
