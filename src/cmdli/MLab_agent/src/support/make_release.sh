...
#
# Revision 1.10  2003/02/10 22:45:33  doug
# switch to objcoms instead of com_broadcast
#
# Revision 1.9  2002/11/01 16:08:16  doug
# renamed libraries
#
# Revision 1.8  2002/10/31 20:25:09  doug
# renamed libenv_objects to libdisplay2d and libdisplay3d
#
# Revision 1.7  2002/10/29 16:49:10  doug
# added libenv_objects
#
# Revision 1.6  2002/10/23 14:30:27  doug
# merging changes back from release
#
# Revision 1.5.2.1  2002/10/23 14:25:40  doug
# update to catch extra packages
#
# Revision 1.5  2002/10/22 20:40:28  doug
...
if ( $#argv == 2 ) then
   set release="V"$argv[1]"_"$argv[2]"-Release"
else
   set release="V"$argv[1]"-Release"
endif
