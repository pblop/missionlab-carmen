#ifndef lines_EXTRA_H
#define lines_EXTRA_H
/**********************************************************************
 **                                                                  **
 **  lines_extra.h                                                    **
 **                                                                  **
...
/* $Id: lines_extra.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
{
// **********************************************************************
class lines_extra : public shape_extra
{
   public:
      // Called by the front rec to create the data record.
      static lines_extra *create(class lines *p);

      // Holds the pointer to the factory function
      static lines_extra *(* factory)(class lines *p);
