...
/* $Id: tile_extra.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
namespace sara
{
class tile_extra : public shape_extra
{
   public:
      // Called by the front rec to create the data record.
      static tile_extra *create(class tile *p);

      // Holds the pointer to the factory function
      static tile_extra *(* factory)(class tile *p);
