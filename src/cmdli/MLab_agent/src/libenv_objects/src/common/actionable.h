...
/* $Id: actionable.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
public:
   ...
   /// The status of the associated action
   typedef enum {UNASSIGNED=0, ASSIGNED, ACTIVE, PERMENENT_FAILURE, TEMPORARY_FAILURE, COMPLETED} STATUS;
   STATUS status;

   /// Stream out the value
   friend ostream & operator << (ostream & out, const actionable &obj);
