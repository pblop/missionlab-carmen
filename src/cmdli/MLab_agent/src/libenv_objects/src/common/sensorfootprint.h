#ifndef sensorfootprint_H
#define sensorfootprint_H
/**********************************************************************
 **                                                                  **
 **  sensorfootprint.h                                                           **
 **                                                                  **
 **  Implement an sensorfootprint-like robot object.                             **
 **                                                                  **
...
/* $Id: sensorfootprint.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

/**********************************************************************
* $Log: sensorfootprint.h,v $
...
namespace sara
{
class sensorfootprint : public shape
{
public:
   /// Constructors
   sensorfootprint();
//   sensorfootprint(const Vector &location, double roll, double pitch, double yaw);
   ...
   /// location of the sensorfootprint
   Vector loc;

   /// attitude of the sensorfootprint
   double roll;
   double pitch;
   double yaw;

   /// Pointer to our parent record
   sensorfootprint(class robot_link *parent);
