...
/* $Id: polygon_extra.cc,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

/**********************************************************************
* $Log: polygon_extra.cc,v $
...
polygon_extra *(* polygon_extra::factory)(class polygon *) = NULL;

/**********************************************************************/
// Create an extra record
polygon_extra *
polygon_extra::create(class polygon *p)
{
   if( factory )
   {
      return factory(p);
