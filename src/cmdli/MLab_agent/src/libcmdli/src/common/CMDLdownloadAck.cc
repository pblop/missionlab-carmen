 ...
 **  CMDLdownloadAck.cc                                              **
 **                                                                  **
 **  the structure defining CMDLdownloadAck messages                 **
 **                                                                  **
...
/* $Id: CMDLdownloadAck.cc,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

///////////////////////////////////////////////////////////////////////
// $Log: CMDLdownloadAck.cc,v $
...
//
// Revision 1.2  2004/06/11 17:21:42  doug
...
CMDLdownloadAck::CMDLdownloadAck() :
   commMsg(MsgTypes::CMDLDOWNLOADACK)
{ /* empty */ }
...
bool 
CMDLdownloadAck::to_stream(stringstream *str) const
{
...
commMsg *
CMDLdownloadAck::from_stream(stringstream *str)
{
   // Create an empty msg record
   CMDLdownloadAck *msg = new CMDLdownloadAck();
...
ostream &operator << (ostream & out, const CMDLdownloadAck &rec)
{
   out << "CMDLdownloadAck:  '" << rec.mission << "' " << rec.version << " cmdlCode:" << endl << rec.cmdlCode << endl;
