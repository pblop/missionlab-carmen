#ifndef CMDLdownloadAck_H
#define CMDLdownloadAck_H
/**********************************************************************
 **                                                                  **
 **  CMDLdownloadAck.h                                               **
 **                                                                  **
...
/* $Id: CMDLdownloadAck.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

///////////////////////////////////////////////////////////////////////
// $Log: CMDLdownloadAck.h,v $
...
{
// *******************************************************************
// downloadAck messages broadcast between the CMDL interpreters
class CMDLdownloadAck: public commMsg
{
public:
   // Constructors
   CMDLdownloadAck();
   ...
   friend ostream &operator << (ostream & out, const CMDLdownloadAck &obj);
};
