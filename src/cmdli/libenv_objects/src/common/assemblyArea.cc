...
/* $Id: assemblyArea.cc,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

/**********************************************************************
* $Log: assemblyArea.cc,v $
...
/**********************************************************************/
// Constructor
assemblyArea::assemblyArea(shape *theShape) :
   env_object(theShape)
{
}
...
/**********************************************************************/
// Constructor
assemblyArea::assemblyArea(shape *theShape, const strings *label) :
...
/**********************************************************************/
// Constructor
assemblyArea::assemblyArea(shape *theShape, const strings *label, const string &new_color) :
