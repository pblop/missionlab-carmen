#ifndef rotocraft_EXTRA_H
#define rotocraft_EXTRA_H
/**********************************************************************
 **                                                                  **
 **  rotocraft_extra.h                                                  **
 **                                                                  **
...
/* $Id: rotocraft_extra.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */

/**********************************************************************
* $Log: rotocraft_extra.h,v $
...
namespace sara
{
class rotocraft_extra : public shape_extra
{
   public:
      // Called by the front rec to create the data record.
      static rotocraft_extra *create(class rotocraft *p);

      // Holds the pointer to the factory function
      static rotocraft_extra *(* factory)(class rotocraft *p);

      // No extra work to do here in creating or deleting
      virtual ~rotocraft_extra() {};
      rotocraft_extra() {};
};
}
/*********************************************************************/
