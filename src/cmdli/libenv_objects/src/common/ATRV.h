 ...
 **  ATRV.h                                                          **
 **                                                                  **
 **  Implement an ATRV-like robot object.                            **
 **                                                                  **
...
/* $Id: ATRV.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
public:
   ...
   /// location of the ATRV
   Vector loc;

   /// attitude of the ATRV
   double roll;
   double pitch;
   double yaw;
