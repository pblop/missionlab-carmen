...
/* $Id: ATRV_extra.h,v 1.1.1.1 2008/07/14 16:44:16 endo Exp $ */
...
{
/**********************************************************************/
class ATRV_extra : public shape_extra
{
   public:
      // Called by the front rec to create the data record.
      static ATRV_extra *create(class ATRV *p);

      // Holds the pointer to the factory function
      static ATRV_extra *(* factory)(class ATRV *p);
