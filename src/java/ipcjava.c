...
JNIEXPORT jint JNICALL
Java_IPC_IPC_IPC_1respond (JNIEnv *env, jclass theClass, jlong msgInstance,
...
JNIEXPORT jlong JNICALL Java_IPC_IPC_IPC_1getContext (JNIEnv *env,
						    jclass theClass)
{
...
Java_IPC_IPC_IPC_1freeByteArray (JNIEnv *env, jclass theClass, jlong byteArray)
{
  IPC_freeByteArray((BYTE_ARRAY)(size_t)byteArray);
}

JNIEXPORT jlong JNICALL Java_IPC_IPC_IPC_1msgFormatter (JNIEnv *env,
						   jclass theClass,
						   jstring msgName)
{
  const char *cmsgName;
...
JNIEXPORT jint JNICALL 
Java_IPC_IPC_IPC_1removeTimerByRef (JNIEnv *env, jclass theClass, jlong timerRef)
{
  return 0;
}
...
JNIEXPORT jint JNICALL
Java_IPC_formatters_formatType (JNIEnv *env, jclass theClass, jlong formatter)
{
...
JNIEXPORT jlong JNICALL
Java_IPC_formatters_formatFormatArrayItemPtr (JNIEnv *env, jclass theClass,
...
JNIEXPORT jint JNICALL
Java_IPC_formatters_formatFormatArrayItemInt (JNIEnv *env, jclass theClass,
					  jlong formatArray, jint n)
{
...
JNIEXPORT jlong JNICALL
Java_IPC_formatters_findNamedFormat (JNIEnv *env, jclass theClass, jlong format)
{
...
JNIEXPORT jlong JNICALL
Java_IPC_formatters_createBuffer(JNIEnv *env, jclass theClass, jlong byteArray)
{
...
JNIEXPORT void JNICALL
Java_IPC_formatters_freeBuffer (JNIEnv *env, jclass theClass, jlong buffer)
{
  free((void *)(size_t)buffer);
}

JNIEXPORT jint JNICALL
Java_IPC_formatters_bufferLength (JNIEnv *env, jclass theClass, jlong buffer)
{
...
JNIEXPORT void JNICALL
Java_IPC_formatters_rewindBuffer (JNIEnv *env, jclass theClass, jlong buffer)
{
  ((BUFFER_PTR)buffer)->bstart = 0;
}

JNIEXPORT void JNICALL
Java_IPC_formatters_printBuffer (JNIEnv *env, jclass theClass, jlong buf)
{
